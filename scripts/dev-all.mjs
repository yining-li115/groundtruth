...
console.log(
  [
    ...
    "",
    `  🖥  Big screen (kiosk):   http://localhost:${KIOSK_PORT}   ← use THIS on this machine`,
    `      (camera/hand-tracking needs localhost or HTTPS — the LAN URL`,
    `       ${kioskUrl} auto-hops to localhost; ?stay=1 to stay)`,
